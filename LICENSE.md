...
Licensed Work: checkmeup (the "Software")
...
monitoring service (cron, uptime, SSL, domain, or port monitoring, alerting,
or status pages) that competes with checkmeup.net. Internal use within your
own organization, including monitoring your own or your clients' systems
without reselling the Software itself as a service, is permitted.
