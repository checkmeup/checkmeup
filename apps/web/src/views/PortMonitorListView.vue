          ...
          <table class="w-full text-sm">
            <thead>
              <tr style="background-color: var(--surface); border-bottom: 1px solid var(--border)">
                ...
                <th class="text-left px-4 py-3 font-medium" style="color: var(--text-muted)">Host:Port</th>
                <th class="text-left px-4 py-3 font-medium" style="color: var(--text-muted)">Expected state</th>
