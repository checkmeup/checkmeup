...
type MonitorType = 'cron' | 'uptime' | 'ssl' | 'domain' | 'port'
...
const typeLabel: Record<MonitorType, string> = {
  cron: 'Cron',
  uptime: 'Uptime',
  ssl: 'SSL',
  domain: 'Domain',
...
const detailRouteName: Record<MonitorType, string> = {
...
function fmtExpiry(daysUntilExpiry: number | null): string {
