...
async function submit() {
  ...
  try {
    const monitor = await monitorsApi.createDns({
      ...
      expectedValue: expectedValue.value.trim() || undefined,
  ...
  <AppLayout>
    <div class="p-8 max-w-xl mx-auto">
      <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-semibold" style="color: var(--text-strong)">New DNS monitor</h1>
      </div>
      ...
      >
        ...
        <div class="flex gap-3 pt-1">
          ...
          <Button variant="secondary" type="button" @click="router.push({ name: 'dns-monitors' })">
            Cancel
          </Button>
        </div>
      </form>
