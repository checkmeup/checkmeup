...
curl -s https://checkmeup.net/ping/&lt;your-monitor-token&gt;</code></pre>
        ...
        <section id="telegram" class="scroll-mt-24">
          ...
          <p class="text-sm leading-relaxed mb-4" style="color: var(--text-dim)">
            Every monitor type alerts through the same Telegram connection. Set it up once in
            Settings:
          </p>
          <ol class="space-y-2 text-sm list-decimal list-inside" style="color: var(--text-dim)">
            ...
            <li>
              Paste that Chat ID into Settings → Telegram alerts and click
        ...
        <section id="email" class="scroll-mt-24">
          ...
          <p class="text-sm leading-relaxed mb-4" style="color: var(--text-dim)">
            A second alert channel alongside Telegram — use one, the other, or both. Set it up in
            <strong style="color: var(--text-strong)">Settings → Email alerts</strong>:
          </p>
          <ol class="space-y-2 text-sm list-decimal list-inside" style="color: var(--text-dim)">
            <li>
              An alert email address is pre-filled with your account email when you sign up — change
              it anytime, e.g. to a shared address like
              <code class="px-1 rounded text-xs" style="background-color: var(--surface-raised)"
            ...
            <li>
              Flip <strong style="color: var(--text-strong)">Enable email alerts</strong> to turn
              the channel on — it's off by default even after an address is saved.
            </li>
          </ol>
          <p class="text-sm leading-relaxed mt-4" style="color: var(--text-dim)">
            Down and recovery alerts carry the same information as the Telegram message — monitor
            name, reason, and timestamp — with a subject line that includes the monitor name and
            "DOWN" for inbox filtering. If both channels are enabled, a single alert event fires on
            each independently; the per-incident alert cap still counts it as one notification, not
            two, so turning on email never doubles your alert volume.
          </p>
        </section>
