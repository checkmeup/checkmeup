...
func TestGetLimits(t *testing.T) {
	cases := []struct {
		...
		{db.PlanHobby, Limits{MonitorTotal: 10, StatusPages: 1, NotificationChannels: 5, MinIntervalMins: 5}},
		{db.PlanSolo, Limits{MonitorTotal: 30, StatusPages: 3, NotificationChannels: 20, MinIntervalMins: 1}},
		{db.PlanStartup, Limits{MonitorTotal: 100, StatusPages: 10, NotificationChannels: 50, MinIntervalMins: 1}},
		{db.PlanEnterprise, Limits{MonitorTotal: 1000, StatusPages: 100, NotificationChannels: 100, MinIntervalMins: 1}},
	}
