...
type Limits struct {
	...
	HideBrandingAllowed  bool // can set status_pages.hide_branding (ADR-035); false on Hobby
}

var planLimits = map[db.Plan]Limits{
	db.PlanHobby:      {MonitorTotal: 10, StatusPages: 1, NotificationChannels: 5, MinIntervalMins: 5, SMSCredits: 0, HideBrandingAllowed: false},
	db.PlanSolo:       {MonitorTotal: 30, StatusPages: 3, NotificationChannels: 20, MinIntervalMins: 1, SMSCredits: 10, HideBrandingAllowed: true},
	db.PlanStartup:    {MonitorTotal: 100, StatusPages: 10, NotificationChannels: 50, MinIntervalMins: 1, SMSCredits: 30, HideBrandingAllowed: true},
	db.PlanEnterprise: {MonitorTotal: 1000, StatusPages: 100, NotificationChannels: 100, MinIntervalMins: 1, SMSCredits: 100, HideBrandingAllowed: true},
}
