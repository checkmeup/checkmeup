...
| [EP-38](ep-38-status-public-handler-split.md) | Split status_public.go by responsibility | 4/4 |
| [EP-39](ep-39-dns-monitoring.md)      | DNS record monitoring           | 0/5           |
| [EP-40](ep-40-monitor-form-extraction.md) | Extract shared monitor form components | 2/6 |
