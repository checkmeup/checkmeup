...
checkmeup needs a billing system for its subscription plans (Hobby $0 / Solo $9 / Startup $29 / Enterprise $79). The founder is an Israeli resident operating as a self-employed individual (עוסק פטור) without a registered company.
